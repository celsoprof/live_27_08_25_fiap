...
@Composable
fun ListaGastosScreen(navegacao: NavHostController) {

    val scrollableState = rememberScrollState()
    val context = LocalContext.current

    // variável collection que vai guardar a lista de despesas
    // obtidas no banco de dados SQLite
    var listaDespesas by remember {
        mutableStateOf(listOf<Despesa>())
    }

    val repository = DespesaRepository(context)

    // Carregar a lista com os dados do banco de dados
    listaDespesas = repository.listarDespesas()
